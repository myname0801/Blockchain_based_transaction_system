        ...
        <div className = "center">
          ...
          <div className = "content">
            ...
            <p className='imgtext'>내 정보</p>
              ...
              <div className = "imgcontent">
              <button><Link to = "/PastReservation"><img className = "imgcss" src="img/review.png" alt="예약정보" /></Link></button>      
                <p className = "imgtext">예약정보</p>
              </div>
              <div className = "imgcontent"> 
                <button><Link to = "/Dealist"><img className = "imgcss" src="img/review.png" alt="리뷰 아이콘" /></Link></button>
                <p className = "imgtext">나의 거래내역</p>
              </div>
              <br/>
          </div>
          <br/>
